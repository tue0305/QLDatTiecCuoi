...
INSERT INTO `sanh` VALUES (5,'LOL',30000.00,'B','12323'),(6,'sdasds',6000.00,'D','dsdsads');
...
CREATE TABLE `thucpham` (
  ...
  `Price` decimal(11,2) NOT NULL,
  `GhiChu` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `LoaiTP` enum('Khai vị','Món chính','Tráng miệng','Nước uống') COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`MaTP`)
...
INSERT INTO `thucpham` VALUES (4,'Diaa',6000.00,'1000',NULL);
...
-- Dump completed on 2019-12-03 23:20:02
